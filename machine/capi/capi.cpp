...
namespace rubinius {
  ...
  MemoryHandle* MemoryHandle::from(VALUE value) {
    ...
    capi_raise_runtime_error("MemoryHandle requested for unknown VALUE type");
  }
  ...
  Object* MemoryHandle::object(VALUE value) {
    ...
    capi_raise_runtime_error("Object reference requested for unknown VALUE type");
  }
  ...
  VALUE MemoryHandle::value(Object* object) {
    ...
    capi_raise_runtime_error("VALUE requested for unknown Object type");
  }
